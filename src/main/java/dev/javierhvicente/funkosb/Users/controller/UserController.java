...
import dev.javierhvicente.funkosb.utils.PaginationLinksUtils;
...
public class UserController {
    ...
    @Autowired
    public UserController(UserService usersService, PedidosService pedidosService, PaginationLinksUtils paginationLinksUtils) {
